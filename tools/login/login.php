...
$msg='<div class="alert alert-danger text-center">
        <i class="far fa-sad-cry"></i> Your api key Incorrect. Please try again dawg.
</div>';
}
}
?>
...
<head>
    ...
    <title>Cawlye Tools Login</title>
...
<h1>Login <small>Cawlye Tools </small></h1>
</div>
<?php 
if(isset($msg)){
echo $msg;
